...
public class Test {
	...
	/*
	 * Implementare l'interfaccia EventSequenceProducerHelpers come indicato nel
	 * metodo
	 ...
	 * punteggio:
	 * 
	 * - implementazione dei cinque metodi nell'helper (ossia, nella parte
	 * obbligatoria è sufficiente
	 * implementarne 4 a piacimento)
	 * 
	 * - la buona progettazione della soluzione, in particolare utilizzando codice
	 * succinto che evita ripetizioni
	 * 
	 ...
	 * 
	 * - correttezza della parte obbligatoria: 10 punti (2.5 per ogni metodo
	 * dell'helper)
	 * 
	 * - correttezza della parte opzionale: 3 punti (ultimo metodo)
	 * 
	 * - qualità della soluzione: 4 punti (3 punti per buon design, 1 punto per no
	...
	public void testFromIterator() {
		...
		// produce i 4 elementi di EVENTS, e poi fallisce nel cercare di produrre il
		// quinto
	...
	public void testAsIterable() {
		...
		// l'iterable ottenuto genera un iteratore che si comporta producendo solo i 4
		// eventi
