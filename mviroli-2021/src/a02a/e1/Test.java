...
/**
 * Si consulti la documentazione della interfaccia RecursiveIteratorHelpers, che
 * modella
 * degli helper (factory e trasformatori) per RecursiveIterator, che a sua volta
 * modella un iterator,
 ...
 * punteggio:
 * - implementazione del quinto metodo helper (ossia, a scelta se ne realizzino
 * 4,
