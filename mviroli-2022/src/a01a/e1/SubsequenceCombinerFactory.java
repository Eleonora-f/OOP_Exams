...
public interface SubsequenceCombinerFactory {
	...
	/**
	 * @return a SubsequenceCombiner that turns triplets of elements into a list of
	 *         them
	 *         e.g.: e1,e2,e3,e4,e5,e6,e7,e8 -->
	 *         List(e1+e2+e3),List(e4+e5+e6),List(e7+e8)
	 */
	<X> SubsequenceCombiner<X, List<X>> tripletsToList();

	/**
	 * @return a SubsequenceCombiner that turns subsequences of integers ending with
	 *         a zero
	...
	/**
	 * @return a generic SubsequenceCombiner that maps one element of the input into
	 *         one of the ouput
	...
	/**
	 * @return a SubsequenceCombiner that turns subsequences of integers as soon as
	 *         their sum
