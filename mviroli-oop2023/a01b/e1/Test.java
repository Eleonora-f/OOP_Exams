...
public class Test {
	 ...
	 * righe (ad esempio: "didattica", "ricerca progetto 1",
	 * "ricerca progetto 2",...)
	...
	public void testFlat() {
		// un time sheet con 3 attività su 5 giorni, con un'ora al giorno su ciascuna
		// attività su ciascun giorno
		...
		assertEquals(Map.of("day1", 3, "day2", 3, "day3", 3, "day4", 3, "day5", 3), sheet.sumsPerDay()); // 3 ore su
																											// ogni
																											// giorno
	}
